"""
Multi-layer perceptron models for image classification.

Implements linear classifier, simple MLP, deep MLP, and deep residual MLP architectures.
"""
...
class MLPClassifier(nn.Module):
    def __init__(
        ...
        super().__init__()
        layers = []
        layers.append(torch.nn.Linear(h * w * 3, 64))
...
class MLPClassifierDeepResidual(nn.Module):
    ...
    def __init__(
        ...
        layers = []
        c = h * w * 3
        layers.append(torch.nn.Linear(c, 16, bias=False))
        c = 16
        for s in hidden_channels:
